...
//Function which show us the booking list.
function ensenarDatos(){
    ...
    // This functions is for deletting a booking.
...
//To access to the post extraction form
...
//To complete the booking after sending the post extraction form
...
//For selecting the cans in case you have use one or more of them
...
var parametros = {"cid" : cid, "idreserva" : reserva, "kage" : kage,};
...
//To cancel a can that you have selecting by an error
...
var parametros = {"#canid" : canid, "idreserva" : reserva, "kage" : kage,};
